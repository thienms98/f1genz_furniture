    ...
    <header class="header">
        ...
        <div class="header-top">
          ...
          <div class="header-center">
            <form class="tool-search" action="/search">
              ...
              <input required="" name="q" autocomplete="off" type="text" placeholder="Bạn c" />
      ...
      <div class="header-menu">
        <div class="container items-center">
          <div class="header-menu-wrap flex-1">
            <div class="header-menu-left">
              ...
              <nav class="header-menu-sidebar text-black">
                <ul>
                  <li class="hasChild">
            ...
            <div class="header-menu-right w-full">
              <Link href="https://www.youtube.com/watch?v=zvkN-cIphMQ" data-fancybox="" title="Video">
                ...
                >
                  <g>
                    ...
                    <circle cx="120.466" cy="256" r="120.466" fill="#ff4f6b" data-original="#ff4f6b" class=""></circle>
                    <path
                      fill="#fb2b3a"
