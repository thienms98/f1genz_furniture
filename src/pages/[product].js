...
const ProductPage = () => {
  ...
  useEffect(() => {
    ...
    const matchedProduct = products.find((prod) => prod.uri === productUri);
      ...
      {product && (
        <main className="main-layout">
          <div className="main-product">
            <div
              className="main-product-breadcrumb"
                ...
                <div className="main-product-share">
                  ...
                  <div className="main-product-share-popup">
                    ...
                    <div className="main-product-share-popup-body">
                      ...
                      <form>
                        <input value="/ban-an-4-chan-gia-dinh-cao-cap" readOnly="" id="main-product-share-copy" />
                  ...
                  <div className="main-product-description-item-data short">
                    ...
                    <p>
                      <em>
                        ...
                        các loại vải và da cao cấp, chăn ga gối đệm của chúng tôi là 100% của Châu Âu. Không giống như
                        các đối thủ cạnh tranh của chúng tôi, các cơ chế của chúng tôi được thực hiện qua nhiều năm và
                        sẽ không thất bại.
                      </em>
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      nghiệp cao cấp cùng công nghệ sản xuất hiện đại mang đến cho người dùng sản phẩm có chất lượng
                      hoàn hảo vượt trội.
                    </p>
                    <p>
                      Những mẫu bàn ghế ăn bằng gỗ đẹp có ưu điểm cứng cáp, thiết kế chắc chắn cùng khả năng chịu lực
                      tốt cho sản phẩm có độ bền cao.
                    </p>
                    ...
                    <p>
                      ...
                      những&nbsp;<strong>mẫu bàn ăn đẹp bằng gỗ tự nhiên</strong>&nbsp;sẽ cho tuổi thọ sản phẩm lên đến
                      30 năm. Còn&nbsp;bàn ghế gỗ công nghiệp&nbsp;cao cấp là 10 năm đến 15 năm.
                    </p>
                    ...
                    <p>
                      <strong>Những mẫu bàn ghế ăn bằng gỗ đẹp</strong>&nbsp;được thiết kế đa dạng mẫu mã, kiểu dáng
                      cùng màu gỗ đặc trưng nổi bật giúp tôn lên vẻ đẹp sang trọng và tinh tế mà không kém phần gần gũi,
                      ấm áp cho không gian phòng ăn gia đình. Không những mang vẻ đẹp thẩm mỹ cao, bộ bàn ăn cao cấp còn
                      góp phần thể hiện phong cách và cá tính của gia chủ.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      Việt Nam mang đến những sản phẩm có tính ổn định cao, không có các hiện tượng co ngót cong vênh,
                      nứt nẻ. Bởi vậy bạn hoàn toàn có thể yên tâm sử dụng loại gỗ này trong thời gian dài mà không phải
                      lo lắng về chất lượng của chúng.
                    </p>
                    <p style={{ textAlign: 'center' }}>
                      <img
                        className="w-auto"
                ...
                <div className="main-product-description-left-item" datatype="page1">
                  <div className="main-product-description-item-data">
                    ...
                    <p>
                      ...
                      khách sử dụng website của chúng tôi, để trả lời các câu hỏi hoặc gửi tài liệu và thông tin Quý
                      khách yêu cầu.
                    </p>
                    <p>
                      <span className="wysiwyg-font-size-medium">
                        Trang web của chúng tôi coi trọng việc bảo mật thông tin và sử dụng các biện pháp tốt nhất để
                        bảo vệ thông tin cũng như việc thanh toán của khách hàng.&nbsp;
                      </span>
                    </p>
                    <p>
                      <span className="wysiwyg-font-size-medium">
